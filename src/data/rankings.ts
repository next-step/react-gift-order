...
export const rankingAll: GiftItem[] = Array.from({ length: 12 }).map((_, i) => ({ ...sampleGift, id: 123 + i }));
export const rankingFemale = rankingAll;
export const rankingMale = rankingAll;
export const rankingTeen = rankingAll;